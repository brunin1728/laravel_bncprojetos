    ...
    <?php include("pages/menu.php"); ?>
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-60">
          <div class="container">
            <h2 class="breadcrumbs-custom-title">Sobre a Agencia</h2>
            <ul class="breadcrumbs-custom-path">
              <li><a href="index.html">Ínicio</a></li>
              <li class="active">Agencia</li>
            </ul>
          </div>
          <div class="box-position" style="background-image: url(images/parallax-1-1920x850.jpg);"></div>
        </div>
      </section>
      ...
      <section class="section section-sm section-first bg-default text-md-left">
        <div class="container">
          <div class="row row-50 justify-content-center align-items-xl-center">
            <div class="col-md-10 col-lg-5 col-xl-6"><img src="images/logo-quadrado-verde.jpg" alt="" width="519" height="564"/>
            </div>
            <div class="col-md-10 col-lg-7 col-xl-6">
              <h2 class="text-spacing-25 font-weight-normal title-opacity-9" STYLE="color: #1bbaba">Porque escolher-nos</h2>
              <!-- Bootstrap tabs-->
              <div class="tabs-custom tabs-horizontal tabs-line" id="tabs-4">
                <!-- Nav tabs-->
                <ul class="nav nav-tabs">
                  <li class="nav-item" role="presentation"><a class="nav-link active" href="#tabs-4-1" data-toggle="tab">Experiência</a></li>
                  <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-4-2" data-toggle="tab">Habilidades</a></li>
                  <li class="nav-item" role="presentation"><a class="nav-link" href="#tabs-4-3" data-toggle="tab">Missão</a></li>
                </ul>
                <!-- Tab panes-->
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="tabs-4-2">
                    <div class="row row-40 justify-content-center text-center inset-top-10">
                      <div class="col-sm-4">
                        <!-- Circle Progress Bar-->
                        <div class="progress-bar-circle" data-value="1" data-gradient="#01b3a7" data-empty-fill="transparent" data-size="150" data-thickness="12" data-reverse="true"><span></span></div>
                        <p class="progress-bar-circle-title">PONTUALIDADE</p>
                      </div>
                      <div class="col-sm-4">
                        <!-- Circle Progress Bar-->
                        <div class="progress-bar-circle" data-value="1" data-gradient="#01b3a7" data-empty-fill="transparent" data-size="150" data-thickness="12" data-reverse="true"><span></span></div>
                        <p class="progress-bar-circle-title">QUALIDADE</p>
                      </div>
                      <div class="col-sm-4">
                        <!-- Circle Progress Bar-->
                        <div class="progress-bar-circle" data-value="1" data-gradient="#01b3a7" data-empty-fill="transparent" data-size="150" data-thickness="12" data-reverse="true"><span></span></div>
                        <p class="progress-bar-circle-title">RESPEITO AO CLIENTE</p>
                      </div>
                    </div>
                  ...
                  <div class="tab-pane fade" id="tabs-4-3">
                    <p>
                    Compreendemos que o caminho mais eficaz para um crescimento consistente a longo prazo reside na demonstração da excelência de nossos serviços. Almejamos que cada experiência com nossas excursões não apenas surpreenda e satisfaça, mas também inspire o desejo de retorno e recomendação a todos que visitem o Rio.
<br>
Dessa forma, priorizamos sempre o respeito pelos nossos clientes e colaboradores, assegurando a qualidade em cada minuciosidade do nosso atendimento.
</p>
                    
                    <div class="group-md group-middle">
                      <a class="button button-width-xl-230 button-primary button-pipaluk" href="#">Entre em contato</a>
                  </div>
